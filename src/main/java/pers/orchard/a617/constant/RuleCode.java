...
public class RuleCode {
    ...
    public static final int INSERT_SOME = 2;

    public static final int UPDATE_MOVE = 3;
    public static final int UPDATE_RENAME = 4;
    public static final int UPDATE_DESCRIPTION = 5;
    public static final int UPDATE_LABELS = 6;
    public static final int UPDATE_MD5 = 7;
